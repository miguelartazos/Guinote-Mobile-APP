...
describe('Fourth Player Rule in Arrastre', () => {
  describe('4th player with partner winning and no suit', () => {
    it('allows 4th player to discard any card when partner is winning and has no suit', () => {
      ...
      expect(isValidPlay(mustTrump, hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(true);
      
      // Non-trump should be invalid since partner is not winning
      const nonTrump = createCard(2, 'bastos');
      expect(isValidPlay(nonTrump, hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(false);
    });
    ...
    it('allows 4th player to play ANY card when partner wins and has no lead suit', () => {
      ...
      expect(isValidPlay(createCard(2, 'bastos'), hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(4, 'copas'), hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(1, 'oros'), hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(true);
    });
    ...
    it('still requires 4th player to follow suit if they have it', () => {
      ...
      expect(isValidPlay(createCard(2, 'espadas'), hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(4, 'copas'), hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(false);
      expect(isValidPlay(createCard(1, 'oros'), hand, trick, 'oros', 'arrastre', 'p3' as PlayerId, gameState)).toBe(false);
    });
  });
  ...
  describe('3rd player must still follow normal rules', () => {
    it('3rd player must trump if no suit and partner not winning', () => {
      ...
      expect(isValidPlay(createCard(1, 'oros'), hand, trick, 'oros', 'arrastre', 'p2' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(2, 'bastos'), hand, trick, 'oros', 'arrastre', 'p2' as PlayerId, gameState)).toBe(false);
    });
    ...
    it('3rd player can discard if partner is winning', () => {
      ...
      expect(isValidPlay(createCard(2, 'bastos'), hand, trick, 'oros', 'arrastre', 'p2' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(4, 'copas'), hand, trick, 'oros', 'arrastre', 'p2' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(1, 'oros'), hand, trick, 'oros', 'arrastre', 'p2' as PlayerId, gameState)).toBe(true);
    });
  });
  ...
  describe('Rule only applies in arrastre phase', () => {
    it('does not apply in draw phase', () => {
      ...
      expect(isValidPlay(createCard(2, 'bastos'), hand, trick, 'oros', 'playing', 'p3' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(4, 'copas'), hand, trick, 'oros', 'playing', 'p3' as PlayerId, gameState)).toBe(true);
      expect(isValidPlay(createCard(1, 'oros'), hand, trick, 'oros', 'playing', 'p3' as PlayerId, gameState)).toBe(true);
    });
  });
});