-- =====================================================
-- MIGRATION 3: Game Functions (03_game_functions.sql)
-- =====================================================
...
-- Function to add AI player (disabled for now)
...
-- Check for errors after game functions
SELECT 'Game functions completed successfully' as status;